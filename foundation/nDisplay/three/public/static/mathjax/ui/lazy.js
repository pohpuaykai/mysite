...
// EXTERNAL MODULE: ../../../../js/ui/lazy/LazyHandler.js
var LazyHandler = __webpack_require__(335);
;// CONCATENATED MODULE: ./lib/lazy.js




if (MathJax.loader) {
  MathJax.loader.checkVersion('ui/lazy', version/* VERSION */.q, 'ui');
}
...
if (MathJax.startup) {
  MathJax.startup.extendHandler(function (handler) {
    return (0,LazyHandler.LazyHandler)(handler);
  });
}
}();
/******/ })()
