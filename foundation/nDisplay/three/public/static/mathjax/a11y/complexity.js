...
var visitor_js_1 = __webpack_require__(175);
...
var MmlVisitor_js_1 = __webpack_require__(176);
var collapse_js_1 = __webpack_require__(850);
var Options_js_1 = __webpack_require__(77);
...
// EXTERNAL MODULE: ../../../../js/a11y/complexity.js
var complexity = __webpack_require__(589);
// EXTERNAL MODULE: ../../../../js/a11y/complexity/collapse.js
var collapse = __webpack_require__(850);
// EXTERNAL MODULE: ../../../../js/a11y/complexity/visitor.js
var visitor = __webpack_require__(175);
// EXTERNAL MODULE: ../semantic-enrich/lib/a11y/semantic-enrich.js
var semantic_enrich = __webpack_require__(511);
...
if (MathJax.loader) {
  MathJax.loader.checkVersion('a11y/complexity', version/* VERSION */.q, 'a11y');
}
...
if (MathJax.startup) {
  MathJax.startup.extendHandler(function (handler) {
    return (0,complexity.ComplexityHandler)(handler);
  });
  (0,global/* combineDefaults */.PV)(MathJax.config, 'options', MathJax.config['a11y/complexity'] || {});
}
}();
/******/ })()
;