...
class ACTwoInductorParallel extends Circuit {
    ...
    act() {
        ...
        const inductor0 = this.createComponent({componentName:'inductor', position:{x:0, y:-5, z:-20}});
        this.enter(inductor0.uuid);
        inductor0.setAllTouchingBoxVisibility(false);//this.render();

        const inductor1 = this.createComponent({componentName:'inductor', position:{x:0, y:5, z:-20}});
