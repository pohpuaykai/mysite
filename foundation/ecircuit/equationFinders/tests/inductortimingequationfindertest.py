...
from foundation.ecircuit.equationFinders.inductortimingequationfinder import InductortimingEquationFinder
...
def cte__ac_twoInductor_series(verbose=False):
...
[4, 2],
    ...
    returnData = []
    eqFinder = InductortimingEquationFinder(networkGraph, id__type, id__positiveLeadsDirections, edge__solderableIndices)
...
def cte__ac_twoInductor_parallel(verbose=False):
    networkGraph = {   0: [2, 6],
    1: [2, 4, 10],
2: [0, 1],
    3: [4, 7],
...
if __name__=='__main__':
    cte__ac_twoInductor_series(True)
    cte__ac_twoInductor_parallel(True)