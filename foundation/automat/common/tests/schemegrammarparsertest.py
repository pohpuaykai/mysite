...
def test__functionCountChanges__distributivity(verbose=False):
    ...
    {'d': 'e', 'e': 19, 'n': 2, 's': 27, 't': 'p', 'v': '$2', 'w': 'd56'},
    {'d': 'e', 'e': 8, 'n': 5, 's': 11, 't': 'p', 'v': '$0', 'w': 'b12'},
    {'d': 'e', 'e': 15, 'n': 4, 's': 15, 't': 'p', 'v': '$1', 'w': 'c34'},
    {'d': 'r', 'e': 8, 'n': 1, 's': 5, 't': 's', 'v': None, 'w': '(+ '},
    {'d': 'r', 'e': 19, 'n': 1, 's': 18, 't': 's', 'v': None, 'w': ')'},
    {'d': 'r', 'e': 22, 'n': 1, 's': 21, 't': 's', 'v': None, 'w': '*'},
    {'d': 'a', 'e': 14, 'n': 1, 's': 13, 't': 's', 'v': None, 'w': '+'}]
    if verbose:
        print('OG:')
        print(schemeword)
        print('result:')
...
def test__latexParserUnparse__sqrtInSqrt(verbose=False):
    ...
    {   'd': 'e',
        ...
        'v': '$4',
        'w': '(sqrt (/ pi 22))'},
    {'d': 'e', 'e': 41, 'n': 3, 's': 43, 't': 'p', 'v': '$1', 'w': 'pi'},
    {'d': 'e', 'e': 32, 'n': 4, 's': 34, 't': 'p', 'v': '$4', 'w': '(sin pi)'},
    {'d': 'r', 'e': 5, 'n': 1, 's': 4, 't': 's', 'v': None, 'w': 'n'},
    {'d': 'r', 'e': 8, 'n': 1, 's': 6, 't': 's', 'v': None, 'w': 'oo'},
    {'d': 'a', 'e': 6, 'n': 1, 's': 4, 't': 's', 'v': None, 'w': 'sq'},
...
if __name__=='__main__':
    ...
    # test__latexParserUnparser__impedanceOfParallelRLCCircuit1(True) # does not work, need some drastic changes, will save first