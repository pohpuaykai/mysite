...
def bipartiteSearch__dc_twoResistor_parallel(verbose=False):
    # from foundation.automat.core.equation import Equation
    list_equationStrs = [
    '(= (+ (+ (- 0 I_{DC_{8}}) I_{R_{0}}) I_{R_{3}}) 0)', #0,0
    '(= (+ (- 0 V_{R_{0}}) V_{DC_{8}}) 0)', #1,4
    '(= (- V_{DC_{8}} V_{R_{3}}) 0)', #2,7
    '(= (/ V_{R_{0}} I_{R_{0}}) R_{R_{0}})', #3,9
    '(= (/ V_{R_{3}} I_{R_{3}}) R_{R_{3}})', #4,11
    '(= (/ V_{DC_{8}} I_{DC_{8}}) R_{DC_{8}})'#5,13
    ]
    list_variables = [
    'I_{DC_{8}}', #0,1
    'I_{R_{0}}', #1,2
