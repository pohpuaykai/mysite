...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (cosh $0) (D $0 $1)) $1)
...
def test__vor1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (sinh $0) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ 2 (+ (cosh (* 2 $0) 1))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (- 0 (* (tanh $0) (sech $0))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (- 0 (* (coth $0) (cosech $0))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ 2 (- 1 (sinh (* 2 $0)))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Hyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (coth $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
