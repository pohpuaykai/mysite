...
from foundation.automat.core.manipulate.pattern.hyperbolictrigonometricdoubleangle import Hyperbolictrigonometricdoubleangle
...
def test__vor0__configTest(verbose=False):
    eqs = '(= y (cosh (* "2" x)))' # fill it in
    eqsType = 'scheme'
    #filename = 'hyperbolictrigonometricdoubleangle'
    direction = 'vor'
    idx = 0
...
def test__hin0__configTest(verbose=False):
    eqs = '(= y (+ (^ (sinh x) "2") (^ (cosh x) "2")))' # fill it in
    eqsType = 'scheme'
    #filename = 'hyperbolictrigonometricdoubleangle'
    direction = 'hin'
    idx = 0
...
def test__hin3__configTest(verbose=False):
    eqs = '(= y (* (* "2" (sinh x)) (cosh x)))' # fill it in
    eqsType = 'scheme'
    #filename = 'hyperbolictrigonometricdoubleangle'
    direction = 'hin'
    idx = 3
...
def test__hin4__configTest(verbose=False):
    eqs = '(= y (/ (* "2" (tanh x)) (+ "1" (^ (tanh x) "2"))))' # fill it in
    eqsType = 'scheme'
    #filename = 'hyperbolictrigonometricdoubleangle'
    direction = 'hin'
    idx = 4
