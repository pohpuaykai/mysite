...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ 1 (nroot 2 (- 1 (* $0 $0)))) (D $0 $1)) $1)
...
def test__hin0__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arcsin $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (- 0 (/ 1 (nroot 2 (- 1 (* $0 $0))))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arccos $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ 1 (+ 1 (* $0 $0))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arctan $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ 1 (* $0 (nroot 2 (- (* $0 $0) 1)))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arcsec $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (nroot 2 (- (* $0 $0) 1)) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arccosec $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (- 0 (/ 1 (+ 1 (* $0 $0)))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arccot $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
