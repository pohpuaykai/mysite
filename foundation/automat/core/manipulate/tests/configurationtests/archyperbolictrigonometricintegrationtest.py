...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (sech (arcsinh $0)) (D $0 $1)) $1)
...
def test__hin0__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arcsinh $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (cosech (arccosh $0)) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arccosh $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ (+ 1 (cosh (* 2 (arctanh $0)))) 2) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arctanh $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (* (- 0 (cosh (arcsech $0))) (coth (arcsech $0))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arcsech $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (* (- 0 (sinh (arccosech $0)))) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arccosech $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (* (/ (- 1 (sinh (arccoth $0))) 2) (D $0 $1)) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometricintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (arccoth $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
