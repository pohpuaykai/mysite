...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arcsin (sin $0))
...
def test__vor1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arccos (cos $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y x)' # $0
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arctan (tan $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y x)' # $0
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
...
def test__vor3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arcsec (sec $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y x)' # $0
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
...
def test__vor4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arccosec (cosec $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y x)' # $0
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
...
def test__vor5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arccot (cot $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y x)' # $0
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
...
def test__hin6__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arccosh (/ 1 $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin7__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arcsinh (/ 1 $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin8__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Arctrigonometricdefinition(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arctanh (/ 1 $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
