...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Logarithmicintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (/ (- (* (* (D $1 $2) (/ 1 $1)) (log e $0)) (* (* (D $0 $2) (/ 1 $0)) (log e $1))) (^ (log e $0) 2)) $2)
...
def test__hin0__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Logarithmicintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (log $0 $1) $3)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Logarithmicintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (/ (D $1 $2) (* $1 (log e $0))) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Logarithmicintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (int (/ (D $0 $1) $1) $1)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Logarithmicintegration(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (+ (log e $0) $2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
