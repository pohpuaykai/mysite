...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (arcsinh $0)
...
def test__hin0__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (log e (+ $0 (nroot 2 (+ (^ $0 2) 1))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor1__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (arccosh $0)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y (log "e" (+ x (nroot "2" (- (^ x "2") "1")))))' # (log e (+ $0 (nroot 2 (- (^ $0 2) 1))))
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (arctanh $0)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (/ (log e (/ (+ 1 $0) (- 1 $0))) 2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin3__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (/ (log e (/ (+ $0 1) (- $0 1))) 2)
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (log e (+ (/ 1 $0) (nroot 2 (- (/ 1 (^ $0 2)) 1))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin5__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Archyperbolictrigonometriclogarithm(eq0, direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply() # (log e (/ (+ 1 (nroot 2 (- 1 (^ $0 2)))) $0))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
    expected = '(= y (arcsech x))' # (arcsech $0)
    ast0, functionsD0, variablesD0, primitives0, totalNodeCount0, startPos__nodeId0 = Schemeparser(equationStr=expected)._parse()
