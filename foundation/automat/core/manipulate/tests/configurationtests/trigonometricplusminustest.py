...
def test__vor0__configTest(verbose=False):
    ...
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (sin (+ $0 $1))
...
def test__hin0__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (+ (* (sin $0) (cos $1)) (* (cos $0) (sin $1)))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (cos (+ $0 $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin2__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (- (* (cos $0) (cos $1)) (* (sin $0) (sin $1)))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (tan (+ $0 $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin4__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (/ (+ (tan $0) (tan $1)) (- 1 (* (tan $0) (tan $1))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor6__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (cosec (+ $0 $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin6__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (/ (* (* (* (sec $0) (sec $1)) (cosec $0)) (cosec $1)) (+ (* (sec $0) (cosec $1)) (* (cosec $0) (sec $1))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor10__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (cot (+ $0 $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin10__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (/ (- (* (cot $0) (cot $1)) 1) (+ (cot $1) (cot $0)))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor12__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (+ (arcsin $0) (arcsin $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin12__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arcsin (+ (* $0 (nroot 2 (- 1 (^ $1 2)))) (* $1 (nroot 2 (- 1 (^ $0 2))))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor14__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (+ (arccos $0) (arccos $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin14__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arccos (- (* $0 $1) (nroot 2 (* (- 1 (^ $0 2)) (- 1 (^ $1 2))))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor16__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (+ (arctan $0) (arctan $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin16__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arctan (/ (+ $0 $1) (- 1 (* $0 $1))))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__vor18__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (+ (arccot $0) (arccot $1))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
...
def test__hin18__configTest(verbose=False):
    ...
    eq0 = Equation(eqs, eqsType)
    ma0 = Trigonometricplusminus(direction, idx, verbose=verbose)
    manipulatedSchemeEquation = ma0.apply(eq0) # (arccot (/ (- (* $0 $1) 1) (+ $1 $0)))
    ast, functionsD, variablesD, primitives, totalNodeCount, startPos__nodeId = Schemeparser(equationStr=manipulatedSchemeEquation)._parse()
    manipulatedAst = ast
