...
class Arctangent(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Tangent.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Tangent.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Tangent.FUNC_NAME: 1, Arctangent.FUNC_NAME: -1}, 0, 0
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Tangent.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Tangent.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Tangent.FUNC_NAME: 1, Arctangent.FUNC_NAME: -1}, 0, 0
