...
class Cosecanth(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount, startPos__nodeId):
        ...
        return {key0: {"newKey": key0, "newValue": ((Arccosecanth.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arccosecanth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Cosecanth.FUNC_NAME: -1, Arccosecanth.FUNC_NAME: 1}, {}, 0, newStartPos__nodeId
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount, startPos__nodeId):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arccosecanth.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arccosecanth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Cosecanth.FUNC_NAME: -1, Arccosecanth.FUNC_NAME: 1}, {}, 0, newStartPos__nodeId
