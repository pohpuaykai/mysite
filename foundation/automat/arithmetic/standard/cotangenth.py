...
class Cotangenth(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Arccotangenth.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arccotangenth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Cotangenth.FUNC_NAME: -1, Arccotangenth.FUNC_NAME: 1}, {}, 0
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arccotangenth.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arccotangenth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Cotangenth.FUNC_NAME: -1, Arccotangenth.FUNC_NAME: 1}, {}, 0
