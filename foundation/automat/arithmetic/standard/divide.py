...
class Divide(Function):
    ...
    def _reverse1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key0][1], (Multiply.FUNC_NAME, replacementDictionary[key0][1][1]))}, key1: {"newKey": key1, "newValue": (replacementDictionary[key0][0], replacementDictionary[key1][1])}}, {Multiply.FUNC_NAME: 1, Divide.FUNC_NAME: -1}, 0, 0
    ...
    def _reverse2(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Divide.FUNC_NAME, replacementDictionary[key0][1][1]))}, key1: {"newKey": key1, "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][0])}}, {}, 0, 0
