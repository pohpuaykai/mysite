...
class Divide(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Multiply.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Multiply.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0], replacementDictionary[key1][1])}}, {Divide.FUNC_NAME: -1, Multiply.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseR1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Divide.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][1])}, key1: {"newKey": (Divide.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][0])}}, {}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Multiply.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Multiply.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1], replacementDictionary[key1][1])}}, {Divide.FUNC_NAME: -1, Multiply.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][1], (Divide.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Divide.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][1])}}, {}, {}, 0, permutation, key0, key1
