...
class Tangent(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Arctangent.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arctangent.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Tangent.FUNC_NAME: -1, Arctangent.FUNC_NAME: 1}, {}, 0
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arctangent.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arctangent.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Tangent.FUNC_NAME: -1, Arctangent.FUNC_NAME: 1}, {}, 0
