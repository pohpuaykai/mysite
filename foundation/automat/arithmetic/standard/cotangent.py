...
class Cotangent(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        One of the list have this tuple ('cot', nodeId) on the #2 argument. Since this is
        ...
        from foundation.automat.arithmetic.standard.arccotangent import Arccotangent
        
        return {key0: {"newKey": key0, "newValue": ((Arccotangent.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arccotangent.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Cotangent.FUNC_NAME: -1, Arccotangent.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arccotangent.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arccotangent.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Cotangent.FUNC_NAME: -1, Arccotangent.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
