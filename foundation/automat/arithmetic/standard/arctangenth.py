...
class Arctangenth(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount, startPos__nodeId):
        ...
        return {key0: {"newKey": key0, "newValue": ((Tangenth.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Tangenth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Arctangenth.FUNC_NAME: -1, Tangenth.FUNC_NAME: 1}, {}, 0, newStartPos__nodeId
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount, startPos__nodeId):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Tangenth.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Tangenth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Arctangenth.FUNC_NAME: -1, Tangenth.FUNC_NAME: 1}, {}, 0, newStartPos__nodeId
