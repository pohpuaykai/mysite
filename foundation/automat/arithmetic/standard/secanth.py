...
class Secanth(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        One of the list have this tuple ('sech', nodeId) on the #2 argument. Since this is
        ...
        return {key0: {"newKey": key0, "newValue": ((Arcsecanth.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arcsecanth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Secanth.FUNC_NAME: -1, Arcsecanth.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arcsecanth.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arcsecanth.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Secanth.FUNC_NAME: -1, Arcsecanth.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
