...
class Exponential(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Nroot.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Nroot.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][1], replacementDictionary[key0][0])}}, {Exponential.FUNC_NAME: -1, Nroot.FUNC_NAME: 1}, {}, 0
    ...
    def _reverseR1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Logarithm.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][1])}, key1: {"newKey": (Logarithm.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][0])}}, {Exponential.FUNC_NAME: -1, Logarithm.FUNC_NAME: 1}, {}, 0
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Nroot.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Nroot.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][1], replacementDictionary[key0][1])}}, {Exponential.FUNC_NAME: -1, Nroot.FUNC_NAME: 1}, {}, 0
    ...
    def _reverseL1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][1], (Logarithm.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Logarithm.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][1])}}, {Exponential.FUNC_NAME: -1, Logarithm.FUNC_NAME: 1}, {}, 0
