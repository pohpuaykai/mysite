...
class Arccosine(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Cosine.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Cosine.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Cosine.FUNC_NAME: 1, Arccosine.FUNC_NAME: -1}, 0, 0
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Cosine.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Cosine.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Cosine.FUNC_NAME: 1, Arccosine.FUNC_NAME: -1}, 0, 0
