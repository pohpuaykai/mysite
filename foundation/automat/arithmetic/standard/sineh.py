...
class Sineh(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Arcsineh.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arcsineh.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Sineh.FUNC_NAME: -1, Arcsineh.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arcsineh.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arcsineh.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Sineh.FUNC_NAME: -1, Arcsineh.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
