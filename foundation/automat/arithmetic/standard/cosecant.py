...
class Cosecant(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        One of the list have this tuple ('cosec', nodeId) on the #2 argument. Since this is
        ...
        return {key0: {"newKey": key0, "newValue": ((Arccosecant.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arccosecant.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Cosecant.FUNC_NAME: -1, Arccosecant.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arccosecant.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arccosecant.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Cosecant.FUNC_NAME: -1, Arccosecant.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
