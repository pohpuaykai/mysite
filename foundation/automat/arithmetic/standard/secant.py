...
class Secant(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        One of the list have this tuple ('sec', nodeId) on the #2 argument. Since this is
        ...
        from foundation.automat.arithmetic.standard.arcsecant import Arcsecant
        
        return {key0: {"newKey": key0, "newValue": ((Arcsecant.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arcsecant.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Secant.FUNC_NAME: -1, Arcsecant.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arcsecant.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arcsecant.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Secant.FUNC_NAME: -1, Arcsecant.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
