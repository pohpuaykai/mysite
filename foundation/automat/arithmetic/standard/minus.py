...
class Minus(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Plus.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Plus.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0], replacementDictionary[key1][1])}}, {Plus.FUNC_NAME: 1, Minus.FUNC_NAME: -1}, 0, 0
    ...
    def _reverseR1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": ((Minus.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][1])}, key1: {"newKey": (Minus.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][0])}}, {}, 0, 0
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Plus.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Plus.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1], replacementDictionary[key1][1])}}, {Plus.FUNC_NAME: 1, Minus.FUNC_NAME: -1}, 0, 0
    ...
    def _reverseL1(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][1], (Minus.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Minus.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key1][0], replacementDictionary[key0][1])}}, {}, 0, 0
