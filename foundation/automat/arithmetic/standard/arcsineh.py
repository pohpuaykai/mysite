...
class Arcsineh(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount, startPos__nodeId):
        ...
        return {key0: {"newKey": key0, "newValue": ((Sineh.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Sineh.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Arcsineh.FUNC_NAME: -1, Sineh.FUNC_NAME: 1}, {}, 0, newStartPos__nodeId
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount, startPos__nodeId):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Sineh.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Sineh.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Arcsineh.FUNC_NAME: -1, Sineh.FUNC_NAME: 1}, {}, 0, newStartPos__nodeId
