...
class Cosine(Function):
    ...
    def _reverseR0(self, replacementDictionary, totalNodeCount):
        ...
        One of the list have this tuple ('cos', nodeId) on the #2 argument. Since this is
        ...
        from foundation.automat.arithmetic.standard.arccosine import Arccosine
        
        return {key0: {"newKey": key0, "newValue": ((Arccosine.FUNC_NAME, replacementDictionary[key0][1][1]), replacementDictionary[key1][0])}, key1: {"newKey": (Arccosine.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][0],)}}, {Cosine.FUNC_NAME: -1, Arccosine.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
    ...
    def _reverseL0(self, replacementDictionary, totalNodeCount):
        ...
        return {key0: {"newKey": key0, "newValue": (replacementDictionary[key1][0], (Arccosine.FUNC_NAME, replacementDictionary[key0][0][1]))}, key1: {"newKey": (Arccosine.FUNC_NAME, key1[1]), "newValue": (replacementDictionary[key0][1],)}}, {Cosine.FUNC_NAME: -1, Arccosine.FUNC_NAME: 1}, {}, 0, permutation, key0, key1
